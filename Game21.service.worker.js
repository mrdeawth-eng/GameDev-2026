...
/** @type {string} */
const CACHE_VERSION = '1783325106|145046938';
/** @type {string} */
const CACHE_PREFIX = 'Game21-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["Game21.html","Game21.js","Game21.offline.html","Game21.icon.png","Game21.apple-touch-icon.png","Game21.audio.worklet.js","Game21.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Game21.wasm","Game21.pck"];
