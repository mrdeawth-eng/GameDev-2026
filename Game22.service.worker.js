...
/** @type {string} */
const CACHE_VERSION = '1783352755|2576252931';
/** @type {string} */
const CACHE_PREFIX = 'Game22-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Game22.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Game22.html","Game22.js","Game22.offline.html","Game22.icon.png","Game22.apple-touch-icon.png","Game22.audio.worklet.js","Game22.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Game22.wasm","Game22.pck"];
